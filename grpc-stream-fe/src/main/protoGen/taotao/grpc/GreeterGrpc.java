...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<taotao.grpc.Message,
      taotao.grpc.Reply> getListMethod;

  public static io.grpc.MethodDescriptor<taotao.grpc.Message,
      taotao.grpc.Reply> getListMethod() {
    io.grpc.MethodDescriptor<taotao.grpc.Message, taotao.grpc.Reply> getListMethod;
    if ((getListMethod = GreeterGrpc.getListMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getListMethod = GreeterGrpc.getListMethod) == null) {
          GreeterGrpc.getListMethod = getListMethod = 
              io.grpc.MethodDescriptor.<taotao.grpc.Message, taotao.grpc.Reply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Greeting.Greeter", "list"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  taotao.grpc.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  taotao.grpc.Reply.getDefaultInstance()))
                  .setSchemaDescriptor(new GreeterMethodDescriptorSupplier("list"))
                  .build();
          }
        }
     }
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void list(taotao.grpc.Message request,
        io.grpc.stub.StreamObserver<taotao.grpc.Reply> responseObserver) {
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractStub<GreeterBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<taotao.grpc.Reply> list(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET:
          ...
          break;
        case METHODID_LIST:
          serviceImpl.list((taotao.grpc.Message) request,
              (io.grpc.stub.StreamObserver<taotao.grpc.Reply>) responseObserver);
          break;
        default:
